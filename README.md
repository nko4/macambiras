...
~~~sh
# getting the code
git clone git@github.com:nko4/macambiras.git && cd ./macambiras/

# developing
npm install
npm start

# deploying (to http://macambiras.2013.nodeknockout.com/)
./deploy nko

# ssh access
ssh deploy@macambiras.2013.nodeknockout.com
ssh root@macambiras.2013.nodeknockout.com
# or, if you get prompted for a password
ssh -i ./id_deploy deploy@macambiras.2013.nodeknockout.com
ssh -i ./id_deploy root@macambiras.2013.nodeknockout.com
~~~
...
~~~html
<iframe src="http://nodeknockout.com/iframe/macambiras" frameborder=0 scrolling=no allowtransparency=true width=115 height=25>
</iframe>
~~~
